...
const jurnalData = [
  {
    ...
    entries: [
      { accountCode: '3101', accountName: 'Prive', debit: 200000, credit: 0 },
      { accountCode: '1001', accountName: 'Kas', debit: 0, credit: 200000 },
    ],
    totalDebit: 200000,
    totalCredit: 200000
  },
  {
    ...
    entries: [
      { accountCode: '6001', accountName: 'Beban Gaji', debit: 500000, credit: 0 },
      { accountCode: '1001', accountName: 'Kas', debit: 0, credit: 500000 },
    ],
    totalDebit: 500000,
    totalCredit: 500000
  }
    ...
    <div className="p-4 sm:p-6 max-w-3xl mx-auto font-sans relative pb-24 animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <div className="flex flex-col gap-4">
        {jurnalData.map(jurnal => (
          <div key={jurnal.id} className="bg-white/60 backdrop-blur-xl border border-white/80 p-4 sm:p-5 rounded-2xl shadow-[0_4px_24px_rgb(0,0,0,0.02)] transition-all hover:shadow-[0_4px_24px_rgb(0,0,0,0.06)]">
